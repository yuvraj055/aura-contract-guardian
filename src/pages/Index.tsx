    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-6 py-20 space-y-20">
        ...
        <section className="space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {quickStats.map((stat, index) => (
              <Card key={index} className="border-0 gradient-card shadow-medium hover:shadow-glow transition-all duration-500 hover-lift group">
                <CardContent className="p-8">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <Badge variant="secondary" className="text-sm bg-muted/50 font-medium">
        ...
        <section className="space-y-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {modules.map((module, index) => (
              ...
              >
                <Card className="h-full border-0 gradient-card shadow-medium hover:shadow-glow transition-all duration-500 hover-lift overflow-hidden group-hover:border-primary/20">
                  {/* Enhanced Header */}
                  <div className={`p-8 bg-gradient-to-br ${module.gradient} border-b border-border/50 relative overflow-hidden`}>
                    ...
                    <div className="relative z-10 flex items-center justify-between mb-6">
                      <div className={`p-4 bg-card rounded-2xl shadow-medium border-2 border-${module.color}/20 group-hover:scale-110 transition-transform duration-300`}>
                  ...
                  <CardContent className="p-8 space-y-6">
                    ...
                    {/* Enhanced CTA Button */}
                    <button className={`w-full py-4 px-6 rounded-xl font-bold transition-all duration-300 bg-gradient-to-r from-${module.color} to-${module.color}/80 text-${module.color}-foreground hover:shadow-${module.color}/25 hover:shadow-lg transform hover:scale-[1.02] shadow-medium`}>
        ...
        <section className="text-center py-16 space-y-8">
          ...
          <Badge className="inline-flex items-center gap-4 px-8 py-4 bg-success/10 text-success rounded-2xl text-lg font-bold border-2 border-success/20 shadow-medium hover:bg-success/15 transition-all duration-300 group">
